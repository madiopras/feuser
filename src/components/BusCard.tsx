...
const BusCard: FC<BusCardProps> = ({ className = "", data }) => {
        ...
        <div className="flex flex-col md:flex-row ">
          ...
          <div className="flex my-5 md:my-0">
            ...
            <div className="ml-4 space-y-10 text-sm">
              ...
              <div className="flex flex-col space-y-1">
                <span className=" text-neutral-500 dark:text-neutral-400">
                  Selasa, 13 Agustus 2025 · 10:00
                </span>
                <span className=" font-semibold">
                  Terminal Pematang Siantar (Pematang Siantar)
                </span>
              </div>
            </div>
          </div>
          ...
          <ul className="text-sm text-neutral-500 dark:text-neutral-400 space-y-1 md:space-y-2">
            <li>Waktu Perjalanan: 7 jam 45 menit</li>
            <li>BK 8912 MA · Sumatera Eksekutif · SHD</li>
          </ul>
        </div>
      </div>
    );
      ...
      <div className="p-4 md:p-8 border border-neutral-200 dark:border-neutral-700 rounded-2xl ">
        ...
        <div className="my-7 md:my-10 space-y-5 md:pl-24">
          ...
          <div className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base">
            Fasilitas : AC, Wifi, Toilet, Kursi, dll
          </div>
          <div className="border-t border-neutral-200 dark:border-neutral-700" />
        </div>
      </div>
  ...
  return (
    <div
      className={`nc-BusCardgroup p-4 sm:p-6 relative bg-white dark:bg-neutral-900 border border-neutral-100
        ...
        <div className="flex  flex-col sm:flex-row sm:items-center space-y-6 sm:space-y-0">
          ...
          <div className="block lg:hidden space-y-1">
            ...
            <div className="text-sm text-neutral-500 font-normal mt-0.5">
              <span className="VG3hNb">SHD</span>
              <span className="mx-2">·</span>
              <span>Super Eksekutif</span>
              <span className="mx-2">·</span>
              <span>7j 45m</span>
            </div>
          </div>
          ...
          <div className="hidden lg:block flex-[4] whitespace-nowrap">
            <div className="font-medium text-lg"> Medan</div>
            <div className="text-sm text-neutral-500 font-normal mt-0.5">
              Terminal Amplas
            </div>
          </div>
          ...
          {/* TYPE */}
          <div className="hidden lg:block flex-[4] whitespace-nowrap">
            <div className="font-medium text-lg">Pematang Siantar</div>
            <div className="text-sm text-neutral-500 font-normal mt-0.5">
